...
var author$project$Inco$FCA = {$: 'FCA'};
var elm$core$Basics$False = {$: 'False'};
var author$project$Main$init = {inco: author$project$Inco$FCA, selecting: false};
...
var author$project$Inco$CFR = {$: 'CFR'};
var author$project$Inco$CIF = {$: 'CIF'};
var author$project$Inco$CIP = {$: 'CIP'};
var author$project$Inco$CPT = {$: 'CPT'};
var author$project$Inco$DAF = {$: 'DAF'};
var author$project$Inco$DDP = {$: 'DDP'};
var author$project$Inco$DDU = {$: 'DDU'};
var author$project$Inco$DEQ = {$: 'DEQ'};
var author$project$Inco$DES = {$: 'DES'};
var author$project$Inco$EXW = {$: 'EXW'};
var author$project$Inco$FAS = {$: 'FAS'};
var author$project$Inco$FOB = {$: 'FOB'};
var author$project$Inco$list = _List_fromArray(
	[author$project$Inco$EXW, author$project$Inco$FCA, author$project$Inco$FAS, author$project$Inco$FOB, author$project$Inco$CFR, author$project$Inco$CIF, author$project$Inco$CPT, author$project$Inco$CIP, author$project$Inco$DAF, author$project$Inco$DES, author$project$Inco$DEQ, author$project$Inco$DDU, author$project$Inco$DDP]);
var author$project$Inco$toString = function (inco) {
	switch (inco.$) {
		case 'EXW':
			return 'EXW';
		case 'FCA':
...
var author$project$Main$OnClose = {$: 'OnClose'};
var author$project$Main$OnSelect = function (a) {
	return {$: 'OnSelect', a: a};
};
var author$project$Main$OnToggle = {$: 'OnToggle'};
...
var author$project$Mdc$Select$selectedClass = F2(
	function (selected, val) {
		return _Utils_eq(selected, val) ? elm$html$Html$Attributes$class('selected') : elm$html$Html$Attributes$class('');
	});
...
var author$project$Mdc$Select$item = F4(
	function (_n0, msgs, toString, val) {
		var selected = _n0.selected;
		return A2(
			elm$html$Html$li,
			_List_fromArray(
				[
					A2(author$project$Mdc$Select$selectedClass, selected, val),
...
var author$project$Mdc$Select$picker = F3(
	function (data, msgs, toString) {
		return A2(
			elm$html$Html$ol,
			_List_Nil,
			A2(
				elm$core$List$map,
				A3(author$project$Mdc$Select$item, data, msgs, toString),
				data.items));
	});
var elm$html$Html$span = _VirtualDom_node('span');
var author$project$Mdc$Select$value = F3(
	function (_n0, msgs, toString) {
		var selected = _n0.selected;
		return A2(
			elm$html$Html$span,
			_List_fromArray(
				[
					elm$html$Html$Events$onClick(msgs.toggle)
				]),
			_List_fromArray(
				[
					elm$html$Html$text(
...
var author$project$Mdc$Select$view = F3(
	function (data, msgs, toString) {
		...
		var nodes = opened ? A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('backdrop'),
							elm$html$Html$Events$onClick(msgs.close)
						]),
					_List_Nil),
					A3(author$project$Mdc$Select$picker, data, msgs, toString)
				])) : A3(author$project$Mdc$Select$value, data, msgs, toString);
		return A2(
...
var author$project$Main$view = function (_n0) {
	var inco = _n0.inco;
	var selecting = _n0.selecting;
	return A3(
		author$project$Mdc$Select$view,
		{items: author$project$Inco$list, opened: selecting, selected: inco},
		{close: author$project$Main$OnClose, select: author$project$Main$OnSelect, toggle: author$project$Main$OnToggle},
		author$project$Inco$toString);
};
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"OnClose":[],"OnSelect":["Inco.Code"],"OnToggle":[]}},"Inco.Code":{"args":[],"tags":{"EXW":[],"FCA":[],"FAS":[],"FOB":[],"CFR":[],"CIF":[],"CPT":[],"CIP":[],"DAF":[],"DES":[],"DEQ":[],"DDU":[],"DDP":[]}}}}})}});}(this));